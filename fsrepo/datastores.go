...
// StorjDatastoreConfig returns a storj DatastoreConfig
func StorjDatastoreConfig(m map[string]interface{}) (DatastoreConfig, error) {
...
func (dsc *DSConfig) DiskSpec() DiskSpec {
	return map[string]interface{}{
